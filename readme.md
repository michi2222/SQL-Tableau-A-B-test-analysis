...
| **PCR (Purchase Conversion Rate)** | Percentage of site visits that ended with a purchase |
| **ATC (Add to Cart)** | Percentage of product viewers who added items to the basket |
| **CPP (Cost Per Purchase)** | Average spend per completed transaction |
...
|:--|--:|--:|--:|--:|
| **Test** | 11.28% | 8.64% | 47.45% | $4.92 |
| **Control** | 5.99% | 9.83% | 66.88% | $4.53 |
...
- **ATC** decreased by **–29%** — fewer users added products to cart.  
